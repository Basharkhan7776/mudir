...
const features = [
  {
    ...
    description:
      "Mudir adapts to you. Build custom inventory structures and define parameters instantly without complex setups.",
  },
  {
    id: "ledger",
    title: "Intuitive Ledger",
    description:
      "Track every movement. Credits, debits, and remarks displayed in a clean, chronological timeline for total clarity.",
  },
  {
    id: "offline",
    title: "Offline-First Core",
    description:
      "No internet? No problem. Mudir stores your data locally on your device, ensuring it is always accessible at speed.",
  },
  {
    id: "data",
    title: "Total Data Ownership",
    description:
      "Your data is yours. Export and Import your entire Mudir database via simple JSON files at any time.",
  },
  {
    id: "orgs",
    title: "Multi-Org Support",
    description:
      "Seamlessly manage distinct suppliers, clients, or personal projects within a single, unified app environment.",
  },
  {
    id: "security",
    title: "Zero Cloud Risk",
    description:
      "Enterprise-grade security on your local hardware. No servers, no leaks, just your business in your pocket.",
  },
];
